...
TransactionBoundaries.prototype._getTransactionBoundaries = function(element) {
  ...
  var waitStateBefore = isWaitStateTask || isWaitStateEvent || isWaitStateGateway || isAsyncBefore,
      waitStateAfter = isAsyncAfter;
 ...
 */
TransactionBoundaries.prototype._addOverlay = function(element, orientation) {
  var position = {};
  var height;
  var width;
  ...
  forEach(transactionBoundaryElements, function(element) {
    ...
    if (element.boundariesBefore) {
      ...
      forEach(element.shape.incoming, function(connection) {
        ...
        self._addOverlay(element, orientation);
      });
    }
